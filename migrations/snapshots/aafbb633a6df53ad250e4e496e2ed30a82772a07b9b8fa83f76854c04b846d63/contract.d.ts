...
export type StorageHash =
  StorageHashBase<'aafbb633a6df53ad250e4e496e2ed30a82772a07b9b8fa83f76854c04b846d63'>;
export type ExecutionHash =
  ExecutionHashBase<'df95fb7718de0fec05a06508e4322af09110635d8b3406d3a8125775f0e43408'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly notifyOnNewMessage: CodecTypes['pg/bool@1']['output'];
      readonly sessionVersion: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly role: 'teacher' | 'student' | 'admin';
      readonly notifyOnNewMessage: CodecTypes['pg/bool@1']['input'];
      readonly sessionVersion: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly NotificationRecipient: {
              ...
              indexes: readonly [
                {
                  readonly name: 'NotificationRecipient_notificationId_idx_adfe2654';
                  readonly prefix: 'NotificationRecipient_notificationId_idx';
                  readonly columns: readonly ['notificationId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'NotificationRecipient_userId_idx_a489d58a';
                  readonly prefix: 'NotificationRecipient_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'NotificationRecipient';
                    readonly columns: readonly ['notificationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            ...
            readonly Role: {
              readonly kind: 'valueSet';
              readonly values: readonly ['teacher', 'student', 'admin'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    ...
    readonly NotificationRecipient: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'NotificationRecipient';
    };
    readonly LoginEvent: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          ...
          readonly NotificationRecipient: {
            ...
            readonly storage: {
              readonly table: 'NotificationRecipient';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
          ...
          readonly User: {
            ...
            readonly relations: {
              ...
              readonly notificationRecipients: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'NotificationRecipient';
                };
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly notifyOnNewMessage: { readonly column: 'notifyOnNewMessage' };
                readonly sessionVersion: { readonly column: 'sessionVersion' };
