        ...
        <article className="typeset typeset-docs">
          ...
          <blockquote>
            <p>
              ...
              <code>typeset.css</code> 排版；若样式缺失或错乱，通常是该样式层未加载。
            </p>
          </blockquote>
          ...
          >
            <h2>快速开始</h2>
            <p>
              本平台是一套<b>协作学习空间</b>：学生与教师按角色进入各自的工作台，
          ...
          >
            ...
            <ul>
              ...
              <li>
                <strong>邮箱</strong>：须为合法邮箱格式，全站唯一，重复注册会被拒绝。
              </li>
              <li>
            ...
            <p>
              注册即登录：账号创建成功的同时会直接建立会话，无需二次登录。
              注册<b>不验证邮箱所有权</b>，仅需确保填写的邮箱可用即可。
            </p>
            ...
            <blockquote>
              <p>
                <b>隐私提示</b>：无论该邮箱是否已注册，系统都会返回同样的成功提示，
          ...
          >
            ...
            <p>
              ...
              缩成几下按键。本文统一以 Windows 的
              <kbd>Ctrl</kbd> 写法示意（macOS 上通常对应 <kbd>⌘</kbd> / <kbd>⌃</kbd>）。
            </p>
            <div className="typeset-scroll">
              <table>
                <thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>打开 / 关闭<b>命令面板</b>（可搜索帮助主题与导航项）。</td>
                    <td>任意位置（输入框内也可）</td>
                  </tr>
                  <tr>
            ...
            <p>
              ...
              <kbd>Ctrl</kbd> + <kbd>K</kbd>，即可输入关键词检索文档主题或浏览导航项。
            ...
            <blockquote>
              <p>
                ...
                记住 <kbd>Ctrl</kbd> + <kbd>B</kbd>（侧栏）与 <kbd>Ctrl</kbd> + <kbd>J</kbd>
                （换肤）这两个高频动作能最快提升日常效率。
              </p>
            </blockquote>
          ...
          >
            ...
            <details>
              ...
              <p>
                生产环境会强制安全请求（<code>SameSite</code> 与仅
                HTTPS Cookie）；本地开发运行在 <code>localhost</code> 时不受影响。
              </p>
            </details>
            ...
            <ul>
              <li>
                请勿在他人设备上保持登录；登出使用 Ctrl+Shift+L。
              </li>
              <li>
                会话 Cookie 为 <code>httpOnly</code>，脚本无法读取，但仍请保管好账号。
              </li>
              <li>
                重置令牌 15 分钟有效，逾期请重新申请；收到后请及时处理。
              </li>
              <li>
          ...
          >
            <h2>致开发者</h2>
            <p>
              本帮助文档由 <code>typeset.css</code> 提供排版，以下是本页用到的主要类型，
              便于后续扩充时对号入座。
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>表格滚动</strong>：宽表外加{" "}
                <code>.typeset-scroll</code> 可横向滚动而不挤破版心。
              </li>
              <li>
